...
|更新指定进货订单|更新关联的库存和供应商信息|待更新的进货订单(必须包含订单号)|是否成功|
|删除指定进货订单|删除关联的库存，更新关联的供应商信息|进货订单号|是否成功|
...
|客户批号||
|送货单号||
|库存号|外键(一个出货订单对应一个库存，一个库存可对应多个出货订单)|
|规格||
|数量||
|单位||
|单价||
...
|更新指定库存|只能更新存放地点、备注|库存号、存放地点|是否成功|
